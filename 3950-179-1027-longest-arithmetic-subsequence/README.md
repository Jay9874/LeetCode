<h2> 3950 179
1027. Longest Arithmetic Subsequence</h2><hr><div><p>Given an array <code>nums</code> of integers, return <em>the length of the longest arithmetic subsequence in</em> <code>nums</code>.</p>
