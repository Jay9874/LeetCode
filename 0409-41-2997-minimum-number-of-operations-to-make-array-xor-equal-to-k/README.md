<h2> 409 41
2997. Minimum Number of Operations to Make Array XOR Equal to K</h2><hr><div><p>You are given a <strong>0-indexed</strong> integer array <code>nums</code> and a positive integer <code>k</code>.</p>
