<h2> 2240 455
1614. Maximum Nesting Depth of the Parentheses</h2><hr><div><p>A string is a <strong>valid parentheses string</strong> (denoted <strong>VPS</strong>) if it meets one of the following:</p>
