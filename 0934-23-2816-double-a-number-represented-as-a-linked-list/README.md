<h2> 934 23
2816. Double a Number Represented as a Linked List</h2><hr><div><p>You are given the <code>head</code> of a <strong>non-empty</strong> linked list representing a non-negative integer without leading zeroes.</p>
